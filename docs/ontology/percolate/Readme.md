...
A database layer called "rem db" (REM - Resources Entities Moments) provides a simple query interface for LLMs to query data in the most convenient way for the natural language query. This can include graph lookups and traversals, semantic search or plain old SQL. 


Percolate can be deployed to your own Cloud - its a batteries included agnetic workflow framework and semantic database for building production grade agents that co-create with you and just get stuff done. 
